...
def run(context):
    ...
    occ1 = af.make_comp(root, "S1"); comp1 = occ1.component
    back_pl = af.off_plane(comp1, comp1.xZConstructionPlane, "s1_w - s1_bt", "S1_BackPl")
    sk, pr = af.sketch_rect_model(comp1, back_pl,
        ("0 in", "s1_w - s1_bt", "0 in"), {"x": "s1_l", "z": "s1_h"}, "S1_Back_Sk", ctx.ev)
    s1_back = af.ext_new(comp1, pr, "s1_bt", "S1_Back").bodies.item(0); s1_back.name = "S1_Back"
    lid_pl = af.off_plane(comp1, comp1.xYConstructionPlane, "s1_h", "S1_LidPl")
    ...
    occ2 = af.make_comp(root, "S2"); comp2 = occ2.component
    bp2 = af.off_plane(comp2, comp2.xZConstructionPlane, "s2_w - s2_bt", "S2_BackPl")
    sk, pr = af.sketch_rect_model(comp2, bp2,
        ("s2_off_x", "s2_w - s2_bt", "0 in"), {"x": "s2_l", "z": "s2_h"}, "S2_Back_Sk", ctx.ev)
    s2_back = af.ext_new(comp2, pr, "s2_bt", "S2_Back").bodies.item(0); s2_back.name = "S2_Back"
    lp2 = af.off_plane(comp2, comp2.xYConstructionPlane, "s2_h", "S2_LidPl")
    sk, pr = af.sketch_rect_model(comp2, lp2,
    ...
    occ3 = af.make_comp(root, "S3"); comp3 = occ3.component
    sk, pr = af.sketch_rect_model(comp3, comp3.xYConstructionPlane,
        ("0 in", "s3_off_y", "0 in"), {"x": "s3_bt", "y": "s3_depth"}, "S3_Side_Sk", ctx.ev)
    s3_side = af.ext_new(comp3, pr, "s3_h", "S3_Side").bodies.item(0); s3_side.name = "S3_Side"
    sk, pr = af.sketch_rect_model(comp3, comp3.xYConstructionPlane,
    ...
    occ4 = af.make_comp(root, "S4"); comp4 = occ4.component
    sk, pr = af.sketch_rect_model(comp4, comp4.xYConstructionPlane,
        ("s4_off_x", "s3_off_y", "0 in"), {"x": "s4_bt", "y": "s4_depth"}, "S4_Side_Sk", ctx.ev)
    s4_side = af.ext_new(comp4, pr, "s4_h", "S4_Side").bodies.item(0); s4_side.name = "S4_Side"
    sk, pr = af.sketch_rect_model(comp4, comp4.xYConstructionPlane,
    ...
    occ5 = af.make_comp(root, "S5"); comp5 = occ5.component
    sk, pr = af.sketch_rect_model(comp5, comp5.xYConstructionPlane,
        ("s5_off_x", "s3_off_y", "0 in"), {"x": "s5_bt", "y": "s5_depth"}, "S5_Side_Sk", ctx.ev)
    s5_side = af.ext_new(comp5, pr, "s5_h", "S5_Side").bodies.item(0); s5_side.name = "S5_Side"
    sk, pr = af.sketch_rect_model(comp5, comp5.xYConstructionPlane,
        ("s5_off_x + s5_bt + s5_gap", "s3_off_y", "0 in"), {"x": "s5_door_w", "y": "s5_bt"}, "S5_Door_Sk", ctx.ev)
    s5_door = af.ext_new(comp5, pr, "s5_h", "S5_Door").bodies.item(0); s5_door.name = "S5_Door"
